...
const translations = {
  en: {
    ...
    'services.offshore.desc': 'Rig mobilisation / demobilisation, anchor-handling, and towing of work/material barges, vessels, etc',
  ...
  id: {
    ...
    'certifications.iso14001': 'ISO 14001',
    'certifications.iso14001.desc': 'Manajemen <br/> Lingkungan',
    ...
    'certifications.kadin.desc': 'Kamar Dagang <br/> Indonesia',
