...
const translations = {
  en: {
    ...
    "about.p1":
      "We are a major marine service provider in Indonesian Oil & Gas exploration and production, also involved in mining and transportation industries. Furthermore, we have represented some of the world’s largest shipowners.",
    "about.p2":
      "Hence, we have the ability to supply tugs and support vessels to work in deep water locations and the capacity to supply vessels even when the job needs to be done on very short notice. This has enabled us to work with confidence for our customers’ needs. Some of our main activities include: ",
    ...
    "expertise.doen.description":
      "We are the sole agent for Doen Pacific Pty. Ltd. PT Sea Horse which provides complete technical support for all Doen Waterjet models in Indonesia, including servicing and spare parts.",
    ...
    "services.offshore.desc":
      "Rig mobilisation / demobilisation, anchor-handling, and towing of work/material barges, vessels, etc",
    "services.vessels.title": "Vessels",
    "services.vessels.desc":
      "Anchor-handling tugs, supply (AHTS) tugs, hook-up and commissioning vessels, supply boats, accommodation, flat-top barges, crew boats and other specialised vessels.",
    "services.brokerage.title": "Brokerage",
    "services.brokerage.desc":
      "PT Sea Horse is a trusted vessel broker for sales & purchase / chartering inquiries. We are able to source for all types of vessels worldwide for our clients.",
    "services.shipping.title": "Shipping & Logistics",
    "services.shipping.desc":
      "PT Sea Horse specializes in cargo movement, expediting, and international freight forwarding. We handle coal, drilling pipes, containers, and general cargo. As shipping agents for major global shipowners, we serve ports across Indonesia.",
    ...
    "footer.copyright":
      "© 2025 P.T. SEA HORSE. All rights reserved. | ISO 9001, ISO 14001, ISO 45001 Certified",
  },
  id: {
    // Navigation
    "nav.home": "Beranda",
    ...
    "hero.description":
      "Didirikan pada tahun 1972, PT Sea Horse merupakan perusahaan penyedia jasa kelautan untuk industri eksplorasi, produksi, pertambangan, dan transportasi Minyak & Gas di Indonesia.",
    ...
    "about.p1":
      "Kami adalah penyedia layanan kelautan dalam eksplorasi dan produksi minyak & gas di Indonesia, juga terlibat dalam industri pertambangan dan transportasinya. Selain itu, kami telah mewakili beberapa pemilik kapal terbesar di dunia.",
    "about.p2":
      "Oleh karena itu, kami memiliki kemampuan untuk menyediakan kapal tunda dan kapal pendukung untuk bekerja di lokasi perairan yang dalam, dan mempunyai  kapasitas untuk menyediakan kapal bahkan ketika pekerjaan harus diselesaikan dalam waktu yang sangat singkat. Beberapa kegiatan utama kami meliputi:",
    "about.activity1": "Kepemilikan dan Pengelolaan Kapal",
    "about.activity2": "Penyewaan Kapal termasuk Penjualan & Pembelian Kapal",
    "about.activity3":
      "Kegiatan Operasional untuk Kapal Tunda (Di Pelabuhan dan Lepas Pantai)",
    "about.activity4":
      "Keagenan Kapal (Pelabuhan, Ijin Masuk/Keluar Kapal dan Awak Kapal, dan lain-lain)",
    "about.activity5": "Agen Umum untuk Kegiatan Pengiriman Batu Bara",

    // Expertise Section
    "expertise.title": "Agen Resmi, Terpecaya dan Terdaftar",
    "expertise.subtitle":
      "Diakui dan dipercaya dalam dengan kemitraan dan lisensi yang terverifikasi.",
    "expertise.doen.description":
      "Kami adalah agen resmi dari Doen Pacific Pty. Ltd. PT Sea Horse menyediakan dukungan teknis lengkap untuk semua model jet kapal Doen di Indonesia, termasuk servis dan suku cadang.",
    ...
    "services.subtitle":
      "Layanan kelautan komprehensif yang disesuaikan untuk memenuhi kebutuhan operasional spesifik Anda.",
    "services.offshore.title": "Layanan Lepas Pantai",
    "services.offshore.desc":
      "Mobilisasi / demobilisasi rig, penanganan jangkar, dan penarikan kapal tongkang untuk barang / material, kapal, dll.",
    "services.vessels.title": "Kapal",
    "services.vessels.desc":
      "Anchor-handling tugs (AHT), Anchor-handling tugs supply (AHTS), Accommodation work barge (AWB), Kapal pendukung, Kapal tongkang, Kapal awak/krew dan kapal khusus lainnya.",
    "services.brokerage.title": "Broker",
    "services.brokerage.desc":
      "PT Sea Horse adalah broker kapal tepercaya untuk kebutuhan jual beli/penyewaan kapal. Kami dapat menyediakan semua jenis kapal di seluruh dunia untuk klien kami.",
    "services.shipping.title": "Pengiriman dan Logistik",
    "services.shipping.desc":
      "PT Sea Horse mempunyai pengalaman dalam pemindahan kargo, ekspedisi, dan pengiriman barang internasional. Kami menangani muatan seperti batu bara, pipa pengeboran, kontainer, dan kargo umum. Sebagai agen pengiriman untuk pemilik kapal global besar, kami melayani pelabuhan di seluruh Indonesia.",

    // Certifications Section
    "certifications.title": "Sertifikasi dan Keanggotaan",
    "certifications.subtitle":
      "Mempertahankan standar tertinggi dalam kualitas dan layanan",
    ...
    "footer.copyright":
      "© 2025 P.T. SEA HORSE. Seluruh hak cipta dilindungi. | Bersertifikat ISO 9001, ISO 14001, ISO 45001",
  },
} as const;
...
export function LanguageProvider({ children }: LanguageProviderProps) {
  ...
  const t = (key: string): string => {
    ...
    // @ts-expect-error indexing by key string
